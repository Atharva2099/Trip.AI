...
const EventChat = ({ event, onClose, onEventUpdate, isActivity = true, currentItinerary, model, provider }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await modifyEvent(userMessage, context, currentItinerary, model, provider);
